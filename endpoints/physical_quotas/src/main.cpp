...
namespace
{
	...
	IRODS_HTTP_API_ENDPOINT_OPERATION_SIGNATURE(op_set_group_quota);
	...
	const std::unordered_map<std::string, irods::http::handler_type> handlers_for_post{
		{"set_group_quota", op_set_group_quota},
...
namespace irods::http::handler
{
	...
	IRODS_HTTP_API_ENDPOINT_ENTRY_FUNCTION_SIGNATURE(physical_quotas)
	{
		// NOLINTNEXTLINE(performance-unnecessary-value-param)
