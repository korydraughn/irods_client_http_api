...
class test_data_objects_endpoint(unittest.TestCase):
    ...
    def test_server_returns_http_status_code_503_when_active_parallel_write_stream_count_exceeds_limit(self):
        ...
        #
        # TODO(?): Update this test to automatically skip/fail based on the
        # HTTP API's configuration.
        ...
        try:
            ...
            # Show that exceeding the active stream limit is detected and results
            # in the expected HTTP status code.
            ...
            # Show that exceeding the active stream limit as a different user results
